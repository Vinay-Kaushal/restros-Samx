...
export function CartIllustration() {
  return (
    ...
    >
      <circle cx="100" cy="100" r="95" fill="#E3A008" fillOpacity="0.12" />
      <path
        ...
        strokeLinecap="round"
      />
      <rect x="50" y="85" width="100" height="70" rx="10" fill="#E3A008" fillOpacity="0.9" />
      <path d="M50 105 H150" stroke="#241A13" strokeWidth="3" strokeOpacity="0.15" />
      <circle cx="75" cy="165" r="9" fill="#241A13" />
      <circle cx="125" cy="165" r="9" fill="#241A13" />
    </motion.svg>
  );
}
